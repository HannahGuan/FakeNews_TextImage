...
class BLIP2FeatureExtractor:
    ...
    def extract_features(
        ...
        """Returns:dict containing: image_embeds [B,256], text_embeds [B,256], similarity_score [B], itm_score [B]"""
        ...
        # move to device and cast if needed, change it according to usage of CPU/GPU
