"""
Model Evaluation Script for Enhanced Multimodal Classifier

Evaluates a trained model checkpoint and generates comprehensive metrics,
...
from finetune_model import EnhancedMultiModalClassifier


class ModelEvaluator:
    """Comprehensive Model Evaluator for Enhanced Multimodal Classifier"""
    ...
    def __init__(
        ...
        """
        Args:
            model: Trained EnhancedMultiModalClassifier
            num_classes: Number of classes (2, 3, or 6)
            classification_type: '2_way', '3_way', or '6_way'
    ...
    def evaluate(self, dataloader: DataLoader):
        ...
        Returns:
            Tuple of (metrics dict, labels, predictions, probabilities, logits)
        """
        all_labels = []
        all_predictions = []
        all_probabilities = []
...
def load_model_checkpoint(checkpoint_path: Path, device: torch.device):
    ...
    if 'dev_acc' in checkpoint:
        print(f"Checkpoint Dev Accuracy: {checkpoint['dev_acc']:.2f}%")
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description="Evaluate Enhanced Multimodal Classifier",
    ...
    parser.add_argument(
        '--checkpoint-path',
        type=str,
        default='grid_search_results/best_model_grid_search.pth',
    ...
    parser.add_argument(
        '--test-csv',
        type=str,
        default='../test_split_2_way_finetune.csv',
